...
MainWindow::MainWindow(QWidget *parent)
    ...
    connect(ui->pushButtonCommandes, &QPushButton::clicked, [this]() { ui->stackedWidget->setCurrentWidget(ui->pagecommande); });
    connect(ui->pushButtonClient, &QPushButton::clicked, [this]() { ui->stackedWidget->setCurrentWidget(ui->pageclients); });
